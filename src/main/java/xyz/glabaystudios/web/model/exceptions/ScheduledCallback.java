...
public class ScheduledCallback {
	...
	public String toString() {
		return String.format(Locale.getDefault(),
				"%s%nAgent: %s%nDate of Callback: %s%nTime of Callback(AST): %s%nLeft off at: %s%nDetailed Reason for callback: %s%n%nRebuttal 1: %s%nApprox time in the call: %s%n%nRebuttal 2: %s%nApprox time in the call: %s",
				getInterview(),
				getAgent(),
				getDate(),
				getCallbackTime(),
